...
class NewronLayer:
    def __init__(self, receptors, newrons) :
        self.weight = np.random.randn(newrons, receptors) * 0.1  # generate random value from Gauss dist and div 10
        self.bias = np.random.randn(newrons, 1) * 0.1  # generate random value from Gauss dist and div 10