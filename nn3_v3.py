...
layer1_nodes = 50
layer1 = NewronLayer(nodes=layer1_nodes, inputs=n-1)    # 4 neurons for the hidden layer with n receptors
layer2 = NewronLayer(nodes=2, inputs=layer1_nodes, output=True)  # 2 neurons for the ouput layer with 4 receptors
